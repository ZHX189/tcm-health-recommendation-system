...
<template>
  <div class="news-manage-page">
    <div class="page-header">
      ...
      <p class="page-desc">管理平台资讯动态，发布健康养生新闻</p>
    </div>

    <div class="search-bar">
      <el-input v-model="searchForm.keyword" placeholder="搜索资讯标题" clearable @keyup.enter="handleSearch">
      ...
      <el-button type="primary" @click="handleAdd">
        <SvgIcon name="add" :size="16" class="mr-8" />新增资讯
      </el-button>
    </div>
    ...
    <div class="table-container">
      <el-table :data="tableData" v-loading="loading" stripe>
        ...
        <el-table-column prop="title" label="资讯标题" min-width="250" />
    ...
    <el-dialog v-model="formVisible" :title="isEdit ? '编辑资讯' : '新增资讯'" width="700px">
...
import { getAdminNewsList, addNews, updateNews, deleteNews, updateNewsStatus } from 'shared/api/admin.js'
...
const formData = reactive({ id: null, title: '', category: '', content: '' })
const formRules = {
...
async function fetchList() {
  ...
  try {
    ...
    tableData.value = [
      { id: 1, title: '春季养生小贴士', category: '养生资讯', status: 1, createTime: '2026-02-03 09:00:00' },
      { id: 2, title: '中医药产业发展报告', category: '行业动态', status: 1, createTime: '2026-02-02 15:30:00' }
    ]
    pagination.total = 2
  } finally {
    loading.value = false
...
function handleAdd() {
  isEdit.value = false
  Object.assign(formData, { id: null, title: '', category: '', content: '' })
...
async function handleUnpublish(row) {
  try {
    ...
    await updateNewsStatus(row.id, 0)
...
<style scoped>
.news-manage-page { min-height: 100%; }
